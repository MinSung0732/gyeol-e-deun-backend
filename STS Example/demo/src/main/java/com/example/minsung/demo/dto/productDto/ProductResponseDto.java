...
public class ProductResponseDto {
    ...
    private String detailImageUrl; // 상세 이미지 URL도 보여주고 싶다면 추가할 수 있습니다.
    private String category; // 카테고리 정보도 보여주고 싶다면 추가할 수 있습니다.
    ...
    public ProductResponseDto(Product product) {
        ...
        this.detailImageUrl = product.getDetailImageUrl(); // 상세 이미지 URL도 세팅
        this.category = product.getCategory(); // 카테고리 정보도 세팅
    }
